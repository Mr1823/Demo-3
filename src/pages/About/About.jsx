            ...
            <div className="bg-[#e2d9ca] p-12 lg:p-16 border border-[#c8a684]/30 space-y-12">
              ...
              <div>
                ...
                <div className="font-body-base text-on-surface-variant space-y-2 flex flex-col">
                  <a href="tel:+918248456747" className="hover:text-primary transition-colors">+91 8248456747</a>
                  <a href="tel:+919443920946" className="hover:text-primary transition-colors">+91 9443920946</a>
                </div>
              </div>
              <div>
                <h3 className="font-display-lg text-[28px] text-primary mb-6">Social</h3>
                <a href="https://instagram.com/sri_ram_jewellery" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 font-body-base text-on-surface-variant hover:text-primary transition-colors">
